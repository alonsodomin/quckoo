...
class PersistentJobSpec extends QuckooActorClusterSuite("PersistentJobSpec")
  ...
  override def beforeEach(): Unit = {
    mediator ! DistributedPubSubMediator.Subscribe(Topic.Registry.name, eventListener.ref)
  }

  override def afterEach(): Unit = {
    mediator ! DistributedPubSubMediator.Unsubscribe(Topic.Registry.name, eventListener.ref)
